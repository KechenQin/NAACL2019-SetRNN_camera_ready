	...
	\resizebox{2.1\columnwidth}{!}{%resize the table
		\begin{tabular}{|l|cc|cc|cc|cccc|}
           ...
           & label-F1 & instance-F1  & label-F1 & instance-F1 & label-F1 & instance-F1 & label-F1 & instance-F1 & Hamming-Loss & Micro-F1 \\
                        ...
                        \hline
            BR
            & .271 & .484 & .486 & .802 &.292 & .572 & - & - & .0316 & .646 \\
            BR-support
            & .247 & .516 & .486 & .805 &.296 & .594 &-&-&-&-\\
            PCC 
            & .279 & .480 & .595 & .818 &- & - & - & - & .0306 & .651 \\
            seq2seq-RNN  
            ...
            &-&-&-&-&-&-& - & - & .0245 & .710 \\
            set-RNN 
             & \textbf{.310} & \textbf{.538} & \textbf{.607} & \textbf{.838}  &\textbf{.361} & \textbf{.607} & \textbf{.548} & \textbf{.731} & \textbf{.0241} & \textbf{.720}\\
            \hline
...
% By design, Vinals-RNN-uniform and set-RNN could spread probabilities mass across many sequence permutations of the same set, Vinals-RNN-sample, Vinals-RNN-max and Vinals-RNN-max-direct tends to allocate most of the probability mass to the top sequence, and seq2seq basically only assigns probability to the sequence in the given order. 
